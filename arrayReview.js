...
console.log(evenGone(evenArray));
...
console.log(numHere(randomArray));
...
var longest = function(str) {
	...
	for (var i = 0; i < strArr.length; i++) {
		if (longestWordLength < strArr[i].length {
...
var capitalize = function(str) {
	var strArr = str.split(" ");
	for (var i = 0; i < strArr.length; i++) {
		var upperChar = strArr[i].charAt(0).toUpperCase();
		strArr[i] = upperChar + strArr[i].substr(1);
		}
	return strArr.join(" ");
};
